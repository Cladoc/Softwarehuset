...
public class ProjectPlanner {
	...
	public void setActivityStartWeek(String week, ActivityID activityID, ProjectID projectID, Developer devLeader) throws OperationNotAllowedException, NullObjectException, FormattingException {
		if(checkDeveloperExist(devLeader)){
			AbstractProject proj = projectsRepo.getProjectRef(projectID);
	...
	public void setActivityStartYear(String year, ActivityID activityID, ProjectID projectID, Developer devLeader) throws OperationNotAllowedException, NullObjectException, FormattingException {
		if(checkDeveloperExist(devLeader)){
			AbstractProject proj = projectsRepo.getProjectRef(projectID);
	...
	public void setActivityEndWeek(String week, ActivityID activityID, ProjectID projectID, Developer devLeader) throws OperationNotAllowedException, NullObjectException, FormattingException {
		if(checkDeveloperExist(devLeader)){
			AbstractProject proj = projectsRepo.getProjectRef(projectID);
	...
	public void setActivityEndYear(String year, ActivityID activityID, ProjectID projectID, Developer devLeader) throws OperationNotAllowedException, NullObjectException, FormattingException {
		if(checkDeveloperExist(devLeader)){
			AbstractProject proj = projectsRepo.getProjectRef(projectID);
