...
public class ProjectPlanner {
	...
	public void registerHours(String week, String year, String hours, ActivityID activityID, DeveloperID developerID,
			ProjectID projectID) throws NullObjectException, FormattingException {
	...
	// Author: Casper (s163950)
	public void setProjectLeader(ProjectID projectID, DeveloperID developerID)
	...
	// Author: Casper (s163950)
	public void addProjectActivity(Activity projectActivity, ProjectID projectID, DeveloperID developerID)
	...
	public boolean checkDeveloperAssigned(ActivityID activityID, ProjectID projectID, DeveloperID developerID)
	...
	public void setExpectedHours(ActivityID activityID, ProjectID projectID, DeveloperID developerID, String hours)
	...
	public void setActivityComplete(ActivityID activityID, ProjectID projectID, DeveloperID developerID)
			throws OperationNotAllowedException, NullObjectException {
		if (checkDeveloperExist(developerID)) {
			AbstractProject proj = projectsRepo.getProjectRef(projectID);
	...
	public boolean isActivityComplete(ActivityID activityID, ProjectID ProjectID, Developer devLeader)
	...
	public void setStartYear(ProjectID projectID, String year, DeveloperID developerID)
			throws Exception, FormattingException, OperationNotAllowedException, NullObjectException {
		if (checkDeveloperExist(developerID)) {
			AbstractProject proj = projectsRepo.getProjectRef(projectID);
	...
	public void setStartWeek(ProjectID projectID, String week, DeveloperID developerID)
			throws Exception, FormattingException, OperationNotAllowedException, NullObjectException {
		if (checkDeveloperExist(developerID)) {
			AbstractProject proj = projectsRepo.getProjectRef(projectID);
	...
	public int getStartWeek(ProjectID projectID)
			throws Exception, FormattingException, OperationNotAllowedException, NullObjectException {
		AbstractProject proj = projectsRepo.getProjectRef(projectID);
		return proj.getStartWeek();
	}

	public int getStartYear(ProjectID projectID)
			throws Exception, FormattingException, OperationNotAllowedException, NullObjectException {
		AbstractProject proj = projectsRepo.getProjectRef(projectID);
		return proj.getStartYear();
	}

	public void setEndYear(ProjectID projectID, String year, DeveloperID developerID)
			throws Exception, FormattingException, OperationNotAllowedException, NullObjectException {
		if (checkDeveloperExist(developerID)) {
			AbstractProject proj = projectsRepo.getProjectRef(projectID);
	...
	public void setEndWeek(ProjectID projectID, String week, DeveloperID developerID)
			throws Exception, FormattingException, OperationNotAllowedException, NullObjectException {
		if (checkDeveloperExist(developerID)) {
			AbstractProject proj = projectsRepo.getProjectRef(projectID);
	...
	public int getEndWeek(ProjectID projectID)
			throws Exception, FormattingException, OperationNotAllowedException, NullObjectException {
		AbstractProject proj = projectsRepo.getProjectRef(projectID);
		return proj.getEndWeek();
	}

	public int getEndYear(ProjectID projectID)
			throws Exception, FormattingException, OperationNotAllowedException, NullObjectException {
		AbstractProject proj = projectsRepo.getProjectRef(projectID);
	...
	public ProjectData getProjectInformation(ProjectID projectID, DeveloperID developerID)
			throws Exception, FormattingException, OperationNotAllowedException, NullObjectException {
		AbstractProject proj = projectsRepo.getProjectRef(projectID);
		return proj.getProjectInformation(developerID);
	}

	public void editProjectName(ProjectID projectID, DeveloperID developerID, String name)
			throws OperationNotAllowedException, FormattingException {
	...
	public void setActivityStartWeek(String week, ActivityID activityID, ProjectID projectID, DeveloperID devLeader)
			throws OperationNotAllowedException, NullObjectException, FormattingException {
	...
	public void setActivityStartYear(String year, ActivityID activityID, ProjectID projectID, DeveloperID devLeader)
			throws OperationNotAllowedException, NullObjectException, FormattingException {
		if (checkDeveloperExist(devLeader)) {
			AbstractProject proj = projectsRepo.getProjectRef(projectID);
	...
	public void setActivityEndWeek(String week, ActivityID activityID, ProjectID projectID, DeveloperID devLeader)
			throws OperationNotAllowedException, NullObjectException, FormattingException {
		if (checkDeveloperExist(devLeader)) {
			AbstractProject proj = projectsRepo.getProjectRef(projectID);
	...
	public void setActivityEndYear(String year, ActivityID activityID, ProjectID projectID, DeveloperID devLeader)
			throws OperationNotAllowedException, NullObjectException, FormattingException {
		if (checkDeveloperExist(devLeader)) {
			AbstractProject proj = projectsRepo.getProjectRef(projectID);
	...
	public List<ActivityID> getActivityIDs(ProjectID selectedProjectID, DeveloperID signedInDeveloperID)
			throws NullObjectException {
